...
class NameForm(forms.Form):
    company_name = forms.CharField(label='Company name', initial = 'Aritari',  max_length=100)
    server_name = forms.CharField(label='Server name',  initial = 'Office Rapid server',max_length=100)
    email = forms.EmailField(label='email@address', initial = 'colin.penfoud@aritari.com')
    ipaddress = forms.GenericIPAddressField(label='IP Adress', initial = '88.150.165.135')
    snmp_community = forms.CharField(label='SNMP Community',  initial = 'public',max_length=100)
